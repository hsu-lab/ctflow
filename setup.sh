...
python3 -m venv srflow            # Create a new virtual environment (venv) using native python3.7 venv
source srflow/bin/activate        # This replaces the python/pip command with the ones from the venv
